...
/**
 * Essa classe foi replicada neste projeto para que sejam usadas as bibliotecas compatíveis com Primefaces 10,
 * pois a classe presente em **omega-5.1.0.jar" é compatível com Primefaces 12.
 * 
 * @author Marcelo
 *
 */
@Named
@ViewScoped
public class CalendarDemoView2 implements Serializable {
